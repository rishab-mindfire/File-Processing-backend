...
class FileService {
    ...
    static uploadFiles(projectId, files) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uploadPromises = files.map((file) => __awaiter(this, void 0, void 0, function* () {
                ...
                return yield fileModel_1.default.create({
                    projectId,
    ...
    static listFiles(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield fileModel_1.default.find({ projectId })
                .select('name size')
                .sort({ createdAt: -1 })
                .lean();
        });
    ...
    static deleteFile(fileId) {
        return __awaiter(this, void 0, void 0, function* () {
            // Find file in DB
            const fileDoc = yield fileModel_1.default.findById(fileId);
            if (!fileDoc) {
            ...
            // Delete DB record
            yield fileModel_1.default.findByIdAndDelete(fileId);
    ...
    static downloadFile(requestParam, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fileDoc = yield fileModel_1.default.findOne({
                _id: fileId,
                projectId: projectId,
            });
            if (!fileDoc) {
