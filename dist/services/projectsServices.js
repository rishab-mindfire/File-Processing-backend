...
class ProjectServices {
    ...
    static createNewProject(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const project = new projectModel_1.default(data);
    ...
    static listAllProjects() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield projectModel_1.default.aggregate([
                { $sort: { createdAt: -1 } },
                {
                    $lookup: {
                        from: 'files',
    ...
    static getProjectWithStats(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stats = yield projectModel_1.default.aggregate([
                { $match: { _id: id } },
                {
                    $lookup: {
                        from: 'files',
    ...
    static deleteProject(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const files = yield fileModel_1.default.find({ projectId });
            ...
            yield Promise.all([
                fileModel_1.default.deleteMany({ projectId }),
                jobModel_1.default.deleteMany({ projectId }),
                projectModel_1.default.findByIdAndDelete(projectId),
            ]);
            return {
...
ProjectServices.updateProject = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield projectModel_1.default.findByIdAndUpdate(id, { $set: data }, { new: true });
});
//# sourceMappingURL=projectsServices.js.map