...
fileCtr.uploadFiles = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const upload = yield file_service_1.FileService.uploadFiles(projectId, files);
...
fileCtr.getFileDetailsList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const files = yield file_service_1.FileService.listFiles(projectId);
...
fileCtr.deleteFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield file_service_1.FileService.deleteFile(fileId);
...
fileCtr.downloadFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield file_service_1.FileService.downloadFile({ fileId, projectId }, res);
    }
    catch (error) {
