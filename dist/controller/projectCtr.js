...
const projectsServices_1 = require("../services/projectsServices");
    ...
    constructor() {
        ...
        this.createProject = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield users_1.userServices.checkEmail(email);
                if (!user) {
                    return res.status(404).json({ error: 'User not found' });
                }
                const project = yield projectsServices_1.ProjectServices.createNewProject({
                    projectName,
                    projectDescription,
                    owner: user._id,
                });
        ...
        this.updateProject = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Update project
                const updatedProject = yield projectsServices_1.ProjectServices.updateProject(id, value);
        ...
        this.listProjects = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const projects = yield projectsServices_1.ProjectServices.listAllProjects();
        ...
        this.viewProject = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const projectWithStats = yield projectsServices_1.ProjectServices.getProjectWithStats(id);
                if (!projectWithStats) {
        ...
        this.deleteProject = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield projectsServices_1.ProjectServices.deleteProject(projectId);
...
//# sourceMappingURL=projectCtr.js.map