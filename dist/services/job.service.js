...
class JobService {
    ...
    static downloadZip(jobId, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const job = yield job_model_1.default.findById(jobId).populate('outputFileId');
            if (!job) {
    ...
    static listZips(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const completedJobs = yield job_model_1.default.find({
    ...
    static deleteZipJob(jobId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (job.outputFileId) {
                const fileDoc = yield file_model_1.default.findById(job.outputFileId);
                ...
                yield file_model_1.default.findByIdAndDelete(job.outputFileId);
            }
            //  Delete job itself
