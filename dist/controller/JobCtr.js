...
JobCtr.createZipJob = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const selectedFiles = yield fileModel_1.default.find({
            _id: { $in: fileIds },
            projectId,
        });
        ...
        const job = yield jobModel_1.default.create({
            projectId,
            status: 'PROCESSING',
            startedAt: new Date(),
        });
        // Start background worker
        jobService_1.JobService.createZip({
            job,
            projectId,
            selectedFiles,
        });
...
JobCtr.getZipsDetailsList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const zips = yield jobService_1.JobService.listZips(projectId);
...
JobCtr.getJobStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Fetch Job by job-id
        const job = yield jobModel_1.default.findById(jobId).select('status progress size');
        // Handle Not Found
        if (!job) {
...
JobCtr.downloadZip = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield jobService_1.JobService.downloadZip(jobId, res);
    }
    catch (error) {
...
JobCtr.deleteZipJob = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield jobService_1.JobService.deleteZipJob(jobId);
...
//# sourceMappingURL=JobCtr.js.map